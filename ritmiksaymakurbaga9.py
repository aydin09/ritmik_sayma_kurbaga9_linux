...
appHighlightFont = font.Font(family='FreeSans', size=11, weight='bold')
appHighlightFont1 = font.Font(family='FreeSans', size=20, weight='bold')
       
label2=Label(text="9'dan 90'a kadar ritmik dokuzar şekilde butonlara basarak tamamlayınız.",font=appHighlightFont)
label2.place(relx = 0.01, rely = 0.95)

labelkr=Label(text="Geçen süre: 0:00:00",fg="black",font=appHighlightFont1)
labelkr.place(relx = 0.67, rely = 0.71)
...
def aşama10():
    ...
    labelkr1.place(relx = 0.67, rely = 0.71)
...
def yenile():
    pencere.destroy()
    os.system("python3 ritmiksaymakurbaga9.py")
